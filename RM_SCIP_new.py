...
if(os.path.exists('/home/username/RM/example-MVC-m/data' + str(now_num) + '.pickle') == False):
    print("No problem file!")

with open('/home/username/RM/example-MVC-m/data' + str(now_num) + '.pickle', "rb") as f:
